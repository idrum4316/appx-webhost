...
var metas = {
    ...
    "appx-login-rows": { "value": "28", "hide": "true" },
    "appx-login-cols": { "value": "110", "hide": "true" },
...
function createScriptsArray(root) {
    arrayScripts = [
        ...
        { "nameLoc": root + "/js/appx-client-utilities" + min + ".js", "type": "js" },
        { "nameLoc": root + "/js/appx-client-local" + min + ".js", "type": "js" },
        { "nameLoc": root + "/js/appx-client-remote" + min + ".js", "type": "js" },
        ...
        { "nameLoc": root + "/js/appx-client-startup" + min + ".js", "type": "js" },
